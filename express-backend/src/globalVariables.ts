...
export const poweruserQuestion = 'Only if I ask you to explixitly create or generate a routine I want you to create a Home Assistant routine. Generate a complete Home Assistant JSON code that sets up the routine. You need to use the instructions I provide you to generate the routine. If not asking for a routine just asnwer me in about my concerning. Just if needed you can take into account the list of appliances I provide you. ';
