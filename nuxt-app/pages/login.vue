...
<template>
    <div class="body-container">
        <div class="form-container">
            ...
            <button class="button" @click="signInWithPassword"> Sign In with E-Mail </button><br />
            <p class="subtext">or you can <NuxtLink class="button-2" to="/signup">Register here</NuxtLink></p>
        </div>
    </div>
</template>
